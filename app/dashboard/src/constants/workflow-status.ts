...
> = {
	scheduled: { label: "Scheduled", color: WORKFLOW_RUN_STATUS_COLORS.scheduled, glyph: "◈" },
	queued: { label: "Queued", color: WORKFLOW_RUN_STATUS_COLORS.queued, glyph: "◇" },
	running: { label: "Running", color: WORKFLOW_RUN_STATUS_COLORS.running, glyph: "●", live: true },
	paused: { label: "Paused", color: WORKFLOW_RUN_STATUS_COLORS.paused, glyph: "❙❙" },
	...
	stalled: { label: "Stalled", color: WORKFLOW_RUN_STATUS_COLORS.stalled, glyph: "⊡" },
	cancelled: { label: "Cancelled", color: WORKFLOW_RUN_STATUS_COLORS.cancelled, glyph: "⊘" },
	completed: { label: "Completed", color: WORKFLOW_RUN_STATUS_COLORS.completed, glyph: "✓" },
	failed: { label: "Failed", color: WORKFLOW_RUN_STATUS_COLORS.failed, glyph: "✕" },
};
