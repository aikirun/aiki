...
description: How the server, workers, endpoints and storage fit together - and why the split is architectural, not physical.
---
...
- The server delivers work two ways:
  - Push (coming soon): a signed HTTP request to Endpoints (serverless, push-based).
