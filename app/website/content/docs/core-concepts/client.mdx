---
title: Client
description: The typed connection to the server, over HTTP or embedded in your process - switching between them is config, not code.
---
...
<Tabs groupId="transport" persist items={["Remote", "Embedded"]}>
<Tab value="Remote">
...
Invokes an in-process server's handler directly — no network hop:
