...
export function baseOptions(): BaseLayoutProps {
	return {
		...
		links: [
			{
				type: "icon",
				url: "https://discord.aiki.run",
				icon: <DiscordIcon />,
				text: "Discord",
				label: "Aiki on Discord",
			},
			{ type: "icon", url: "https://x.com/aiki_run", icon: <XIcon />, text: "X", label: "Aiki on X" },
			{
				type: "icon",
				url: "https://www.linkedin.com/company/aiki-run",
				icon: <LinkedInIcon />,
				text: "LinkedIn",
				label: "Aiki on LinkedIn",
			},
		],
	};
}
