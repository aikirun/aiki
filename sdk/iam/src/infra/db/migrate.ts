...
import { migrateApply as _migrateApply, directoryMigrationSource, type MigrationSource } from "@aikirun/lib/db/migrate";
...
export function migrationSource(provider: DatabaseProvider): MigrationSource {
	...
	return directoryMigrationSource(migrationsDir);
}
