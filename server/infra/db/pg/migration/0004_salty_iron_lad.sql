...
ALTER TABLE "workflow_run_outbox" ADD COLUMN "rank" double precision DEFAULT 10 NOT NULL;--> statement-breakpoint
ALTER TABLE "workflow_run_outbox" ALTER COLUMN "rank" DROP DEFAULT;--> statement-breakpoint
