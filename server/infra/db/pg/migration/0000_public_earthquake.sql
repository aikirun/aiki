...
ALTER TABLE "workflow_run" ADD CONSTRAINT "fk_workflow_run_namespace_id" FOREIGN KEY ("namespace_id") REFERENCES "public"."namespace"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
