...
- [`@aikirun/codec`](https://www.npmjs.com/package/@aikirun/codec) — Toolkit for payload transformation (e.g., encryption, encoding, offloading to the object storage, etc.) 
